...
public class NotificationReceiver extends NotificationListenerService {
    ...
    public void onNotificationPosted(android.service.notification.StatusBarNotification sbn) {
        Log.i("NotificationListener", "onNotificationPosted: " + sbn.getPackageName());
        Log.i("NotificationListener", "onNotificationPosted: " + sbn.getNotification().tickerText);
        Log.i("NotificationListener", "onNotificationPosted: " + sbn.getNotification().extras.getString("android.title"));
        Log.i("NotificationListener", "onNotificationPosted: " + sbn.getNotification().extras.getString("android.text"));
        //打印通知的相关信息
